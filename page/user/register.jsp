...
<script type="text/javascript">
	...
	function verificate(){
		...
		var vtype="register";
		if (!document.getElementById('userName-error') || !document.getElementById('userEmail-error') || !document.getElementById('userPassword-error') || !document.getElementById('confirm_Password-error')) {
			alert('请先填写完整信息');  
			return false;
			}
